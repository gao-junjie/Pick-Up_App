...
@interface BaseScanViewController () <AVCaptureMetadataOutputObjectsDelegate>
...
- (void)viewDidLoad
{
    ...
    else
    {
        ...
        [alter addAction:[UIAlertAction actionWithTitle:@"我知道了" style:UIAlertActionStyleDefault handler:nil]];
